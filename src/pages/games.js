    ...
    <div>
      ...
      <div className="content_main">
        <article>
          ...
          <p>
            Just a little fun project to test interactivity in the browser. The Magic Answers requires you to finish the
            question with the correct punctuation. There are 20 possible answers. Rock, Paper, Scissors uses emojis and
            a random number to decide the computer choice. If you open the console you can see the game in text form.
          </p>
        </article>
        <aside>
