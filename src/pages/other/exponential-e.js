  ...
  return (
    <div>
      <Head>
        ...
        <meta property="og:image" content="https://s3.eu-north-1.amazonaws.com/web.mc/assets/favicons/og_expo.png" />
        <meta name="twitter:image" content="https://s3.eu-north-1.amazonaws.com/web.mc/assets/favicons/og_expo.png" />
      </Head>
      <SEO />
      <h1 className="article_title">Exponential-e</h1>
      <div className={styles.container}>
        <article>
          <h1 className={styles.title}>Exponential-e</h1>
          <p>Work done for a managed service provider based in London with global reach.</p>
        </article>
        <article>
          <h2>Videos</h2>
          <div className="margin_big"></div>
          <div className="video_galery">
