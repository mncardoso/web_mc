      ...
      <div className={styles.container}>
        <div className="content_main">
          <article>
            ...
            <p>
              Brand building, logo and presentation for a lodging business in rural Portugal.{' '}
              <Button action={'./other/casa_rustica'} lable={'Read the case-study'} title={'Read the case-study'} />
            </p>
          </article>
        ...
        <div className="content_main">
          <article>
            ...
            <p>
              A selection of work done when working for one of the biggest managed service providers in the United
              Kingdom. <Button action={'./other/exponential-e'} lable={'Have a look'} title={'Have a look'} />
            </p>
          </article>
        ...
        <div className="content_main">
          <article>
            ...
            <p>
              <Button action={'./other/other'} lable={'Here'} title={'Here'} /> is a selection of other design works I
              did. :)
            </p>
          </article>
        </div>
