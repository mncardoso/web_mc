  ...
  timeline: [
    {
      ...
      date: '2007-2010',
      type: 'education',
      description: ['Learned to draw in CAD, to model in 3D for architecture and to make photo realistic renders.'],
      skills: ['Adobe Photoshop', 'Adobe Illustrator', 'ArchiCAD', 'SketchUp', 'Cinema 4D', 'Blender'],
    },
    {
    ...
    },
    {
      ...
      date: '2013',
      type: 'award',
      description: ['Won an honourable mention in the final project “Inner Shell” as Technical Director.'],
    ...
    },
    {
      ...
      skills: ['Audiovisual Production', 'Audiovisual Engineering', 'Final Cut Pro'],
    },
    {
      company: 'MONSTRA | Lisbon Animation Festival',
    ...
    },
    {
      ...
      skills: ['Adobe Photoshop', 'Adobe Illustrator', 'Adobe InDesign', 'Adobe Premiere Pro', 'Adobe After Effects'],
